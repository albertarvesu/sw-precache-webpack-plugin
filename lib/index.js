  ...
  _createClass(SWPrecacheWebpackPlugin, [{
    ...
    value: function createServiceWorker() {
      ...
      return _swPrecache2.default.generate(this.workerOptions).then(function (serviceWorkerFileContents) {
        if (_this3.options.minify) {
          ...
          return _uglifyEs2.default.minify(uglifyFiles).code;
        }
    ...
    value: function writeServiceWorker(serviceWorker, compiler) {
      ...
      return new Promise(function (resolve, reject) {
        outputFileSystem.mkdir(_path2.default.resolve(filepath, '..'), { recursive: true }, function (mkdirErr) {
          if (mkdirErr) {
            reject(mkdirErr);
            return;
          }
          outputFileSystem.writeFile(filepath, serviceWorker, function (writeError) {
            if (writeError) {
              reject(writeError);
            } else {
              resolve();
